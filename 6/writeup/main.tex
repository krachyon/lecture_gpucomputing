...
\begin{figure}
    \includegraphics[width=\textwidth]{../result/full_bw.pdf}
\end{figure}
\begin{figure}
    \includegraphics[width=\textwidth]{../result/exec_bw.pdf}
\end{figure}
\begin{figure}
    \includegraphics[width=\textwidth]{../result/naive_bs.pdf}
\end{figure}
\begin{figure}
    \includegraphics[width=\textwidth]{../result/shared_bs.pdf}
\end{figure}
