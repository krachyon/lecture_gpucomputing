...
{
//    std::vector<float> in0(1,1);
//    EXPECT_FLOAT_EQ(1, reduce_cpu_async(in0));
//    std::vector<float> in(1000,1);
//    EXPECT_FLOAT_EQ(1000, reduce_cpu_async(in));
//    std::vector<float> in2(2000,1);
//    EXPECT_FLOAT_EQ(2000, reduce_cpu_async(in2));

    std::vector<float> in3(2000000000,1);
    EXPECT_FLOAT_EQ(2000000000, reduce_cpu_async(in3));
}
